...
describe('Calendar', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('displays date buttons for current month', () => {
      ...
      for (let day = 1; day <= 31; day++) {
        ...
        expect(screen.getByRole('button', { name: dateString })).toBeInTheDocument();
      }
    });

    it('applies custom className', () => {
      createCalendar({ className: 'custom-calendar' });
      expect(screen.getByRole('grid').closest('.rdl-calendar')).toHaveClass('custom-calendar');
    });
  });
    ...
    it('highlights today', () => {
      ...
      if (today.getMonth() === currentDate.getMonth() && today.getFullYear() === currentDate.getFullYear()) {
        ...
        const todayButton = screen.getByRole('button', { 
          name: new RegExp(`${String(today.getMonth() + 1).padStart(2, '0')}/${String(today.getDate()).padStart(2, '0')}/${today.getFullYear()}`)
        });
  ...
  describe('Date Constraints', () => {
    it('disables dates before minDate', () => {
      ...
      const beforeMinButton = screen.getByRole('button', { name: '01/14/2024' });
    ...
    it('disables dates in disabledDates array', () => {
      ...
      const disabledButton1 = screen.getByRole('button', { name: '01/15/2024' });
      const disabledButton2 = screen.getByRole('button', { name: '01/20/2024' });
  ...
  describe('Locale Support', () => {
    it('uses custom locale for month names', () => {
      ...
      expect(screen.getByRole('button', { name: /Enero 2024/ })).toBeInTheDocument();
    });
  ...
  describe('Date Adapter Integration', () => {
    it('uses date adapter for date calculations', () => {
      const customAdapter = {
        ...
        startOfMonth: jest.fn().mockImplementation(nativeDateAdapter.startOfMonth),
        ...
        isSameMonth: jest.fn().mockImplementation(nativeDateAdapter.isSameMonth),
  ...
  describe('Edge Cases', () => {
    it('handles leap year correctly', () => {
      ...
      expect(screen.getByRole('button', { name: '02/29/2024' })).toBeInTheDocument(); // Feb 29 should exist
    });
    ...
    it('handles non-leap year correctly', () => {
      ...
      expect(screen.getByRole('button', { name: /February 2023/ })).toBeInTheDocument();
      expect(screen.queryByRole('button', { name: '02/29/2023' })).not.toBeInTheDocument(); // Feb 29 should not exist
    });
    ...
    it('handles month boundaries correctly', () => {
      ...
      expect(screen.getByRole('button', { name: '01/31/2024' })).toBeInTheDocument();
    ...
    it('handles year boundaries correctly', () => {
      ...
      expect(screen.getByRole('button', { name: /December 2024/ })).toBeInTheDocument();
    });
  ...
  describe('Accessibility', () => {
    ...
    it('provides proper focus management', async () => {
      ...
      const firstDateButton = screen.getByRole('button', { name: '01/01/2024' });
